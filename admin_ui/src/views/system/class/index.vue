<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="classList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="类别主键" align="center" prop="id" />
      <el-table-column label="名称" align="center" prop="name" />
      <el-table-column label="类别所属" align="center" prop="type" />
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        type: [
          { required: true, message: "类别所属不能为空", trigger: "change" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除分类类别总编号为"' + ids + '"的数据项？').then(function() {
        return delClass(ids);
      }).then(() => {
        this.getList();
