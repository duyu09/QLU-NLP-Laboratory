<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="名称" prop="nameTitle">
        <el-input
      ...
      <el-form-item label="人物照片位置" prop="imgUrl">
        <el-input
          v-model="queryParams.imgUrl"
          placeholder="请输入人物照片位置"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="characterList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="名称" align="center" prop="nameTitle" />
      <el-table-column label="人物照片位置" align="center" prop="imgUrl" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="名称" prop="nameTitle">
          <el-input v-model="form.nameTitle" placeholder="请输入名称" />
        </el-form-item>
        <el-form-item label="人物照片位置" prop="imgUrl">
          <el-input v-model="form.imgUrl" placeholder="请输入人物照片位置" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除人物志数据编号为"' + ids + '"的数据项？').then(function() {
